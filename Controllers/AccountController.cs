...
namespace yusuanxiangmu.Controllers
{
    ...
    public class AccountController : Controller
    {
        public AccountController()
            : this(new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new MyUserDbContext())))
        {
        }
        ...
        //
        // GEG: /Account/UserRolesLu  把角色复选框改为单选框，
        [Authorize(Roles = "Admin")]
        //
        public ActionResult UserRolesLu(string id)
        {
            var Db = new MyUserDbContext();
            var user = Db.Users.First(u => u.UserName == id);
       ...
       [Authorize(Roles = "Admin")]
        [ValidateAntiForgeryToken]
        public ActionResult UserRolesLu(FormCollection form)
        {
            string UserName = form["UserName"];
            string RoleName = form["roleselected"];                            
            var idManager = new IdentityManager();
            var Db = new MyUserDbContext();
